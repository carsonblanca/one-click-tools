...
export const BRAND_CATALOG: BrandEntry[] = [
  ...
  { id: "r3d",         name: "R3D",         nameZh: "爱三迪", aliases: ["r3d","爱三迪"], popularityRank: 7,  filamentCount: 2, verificationStatus: "verified" },
  ...
  { id: "aliz",        name: "ALIZ",        nameZh: "爱丽兹",   aliases: ["aliz","爱丽兹"], popularityRank: 9,  filamentCount: 21, verificationStatus: "pending" },
  { id: "mochuang",    name: "MOCHUANG",    nameZh: "魔创",     aliases: ["mochuang","魔创","alchemakes"], popularityRank: 10, filamentCount: 12, verificationStatus: "pending" },
