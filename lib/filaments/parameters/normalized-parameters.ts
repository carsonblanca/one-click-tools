...
export const FILAMENT_PARAMETER_DEFINITIONS = Object.freeze([
  definition("materialType", "材料类型", ["material", "material type", "材质", "材料", "材料类型"], null, "基础", 10),
  definition("filamentDiameter", "线径", ["diameter", "filament diameter", "线径", "丝径", "耗材直径"], "mm", "基础", 20),
  definition("netWeight", "净重", ["net_weight", "net weight", "净重", "线材净重", "净含量", "重量"], "g", "基础", 30),
  ...
  definition("tensileStrength", "拉伸强度", ["tensile strength", "拉伸强度", "抗拉强度"], "MPa", "机械性能", 200),
  definition("elongationAtBreak", "断裂伸长率", ["elongation at break", "断裂伸长率", "断裂延伸率", "拉伸断裂伸长率"], "%", "机械性能", 210),
  definition("impactStrength", "冲击强度", ["冲击强度"], "kJ/m²", "机械性能", 220),
  definition("unnotchedImpactStrength", "无缺口冲击强度", ["unnotched impact strength", "无缺口冲击强度"], "kJ/m²", "机械性能", 221),
  definition("notchedImpactStrength", "缺口冲击强度", ["notched impact strength", "缺口冲击强度", "有缺口冲击强度"], "kJ/m²", "机械性能", 222),
  definition("flexuralStrength", "弯曲强度", ["flexural strength", "弯曲强度"], "MPa", "机械性能", 230),
  definition("flexuralModulus", "弯曲模量", ["flexural modulus", "弯曲模量"], "MPa", "机械性能", 240),
  definition("heatDeflectionTemperature", "热变形温度", ["hdt", "heat deflection temperature", "热变形温度", "热变形温度hdt"], "°C", "热性能", 300),
  definition("vicatSofteningTemperature", "维卡软化温度", ["vicat", "vicat softening temperature", "维卡软化温度", "维卡温度"], "°C", "热性能", 310),
  definition("dryingTemperature", "干燥温度", ["drying temperature", "烘干温度", "干燥温度"], "°C", "干燥", 400),
  definition("dryingTime", "干燥时间", ["dryingDuration", "drying time", "烘干时长", "烘干时间", "干燥时长", "干燥时间"], "h", "干燥", 410),
] as const);
